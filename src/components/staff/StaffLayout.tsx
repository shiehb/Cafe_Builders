...
import { ChefHat, CreditCard, LayoutDashboard, ShoppingBag, Lock, Volume2, VolumeX, Radio, Sparkles } from "lucide-react";
...
export const StaffLayout: React.FC<StaffLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100 flex flex-col font-sans">
      {/* Staff Header */}
      <header className="sticky top-0 z-40 bg-stone-900/95 backdrop-blur-md border-b border-stone-800 shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-15 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-mono font-semibold">
          ...
          <nav className="flex items-center bg-stone-950/80 p-1 rounded-xl border border-stone-800/80">
            <button
              type="button"
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={() => navigate("/")}
              className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-stone-800 hover:bg-stone-700 border border-stone-700 text-stone-300 hover:text-white text-xs font-semibold transition-all cursor-pointer"
